...
export class ConstantUrl {
    ...
    public readonly simplefournisseurUrl : string = this.baseUrl+"facturesfournisseur-simple";
     ...
     public readonly pdfUrl : string = this.baseUrl+"pdf";
     public readonly pdfDevissUrl : string = this.pdfUrl+"/devis";
     public readonly pdfFactSimsUrl : string = this.pdfUrl+"/factureSimple";
     public readonly pdfFactAcomUrl : string = this.pdfUrl+"/factureAcompte";
     public readonly pdfFactAvoirUrl : string = this.pdfUrl+"/factureAvoir";
