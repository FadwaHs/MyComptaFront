...
links: Link[] = [
  ...
  { path: 'AC', label: 'DATA_NAME.ACH', isActive: true, hasHoverMenu : true, hoverMenuItem: [ {label:'DATA_NAME.CFF', path:"/environment/1/facturation/factures-fournisseur/simple/add"}, {label:'DATA_NAME.LFF', path:"/environment/1/facturation/factures-fournisseur/simple"}, {label:'DATA_NAME.CAF', path:"/environment/1/facturation/factures-fournisseur/avoir/add"} , {label:'DATA_NAME.LAF', path:"/environment/1/facturation/factures-fournisseur/avoir"}, {label:'DATA_NAME.CBL', path:"environment/1/facturation/bons/livraison/add"}, {label:'DATA_NAME.LBL', path:"environment/1/facturation/bons/livraison"}, {label:'DATA_NAME.CBC', path:"environment/1/facturation/bons/commande/add"}, {label:'DATA_NAME.LBC', path:"environment/1/facturation/bons/commande"}], verticalSpacing: 47.7 },
