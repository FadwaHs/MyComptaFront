...
links: Link[] = [
  ...
  { path: 'AC', label: 'DATA_NAME.ACH', isActive: true, hasHoverMenu : true, hoverMenuItem: [{label:'DATA_NAME.CFF', path:""}, {label:'DATA_NAME.LFF', path:""}, {label:'DATA_NAME.CAF', path:""} , {label:'DATA_NAME.LAF', path:""}, {label:'DATA_NAME.CBC', path:""}, {label:'DATA_NAME.LBC', path:""}, {label:'DATA_NAME.CBL', path:"environment/1/facturation/bons/livraison/add"}, {label:'DATA_NAME.LBL', path:"environment/1/facturation/bons/livraison"},], verticalSpacing: 47.7 },
