...
links: Link[] = [
  ...
  { path: 'AC', label: 'DATA_NAME.ACH', isActive: true, hasHoverMenu : true, hoverMenuItem: [ {label:'DATA_NAME.CFF', path:"/environment/1/facturation/factures-fournisseur/simple/add"}, {label:'DATA_NAME.LFF', path:"/environment/1/facturation/factures-fournisseur/simple"}, {label:'DATA_NAME.CAF', path:"/environment/1/facturation/factures-fournisseur/avoir/add"} , {label:'DATA_NAME.LAF', path:"/environment/1/facturation/factures-fournisseur/avoir"} ], verticalSpacing: 47.7 },
