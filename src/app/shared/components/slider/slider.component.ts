...
export class SliderComponent implements OnInit {
  ...
  links: Link[] = [
    ...
    { path: 'AC', label: 'DATA_NAME.AC', isActive: false, hasHoverMenu : true, hoverMenuItem: ['DATA_NAME.IF', 'DATA_NAME.SF', 'DATA_NAME.CFF', 'DATA_NAME.LFF', 'DATA_NAME.CAF', 'DATA_NAME.LAF', 'DATA_NAME.CBC', 'DATA_NAME.LBC', 'DATA_NAME.CBL', 'DATA_NAME.LBL', 'DATA_NAME.DLD'], verticalSpacing: 47.7 },
